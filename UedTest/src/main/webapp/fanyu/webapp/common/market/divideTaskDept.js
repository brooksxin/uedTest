define(['handlebars', 'dialog', 'text!tpl/market/divideTaskDept.tpl', 'text!tpl/market/divideTaskDept-list.tpl', 'jquery', 'underscore', 'jquery.countdown']
	, function(Handlebars, dialog, tpl, listTpl, $){
	...
	var saveResult = function(e){
		...
		//分配任务
		var str2= $("#divideTask", _el).serialize(); //把form序列化
