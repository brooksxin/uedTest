...
},plugins:["draggable","droppable","resizable","pagination2","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
(function($){
function _9e(_9f){
var _a0=$.data(_9f,"pagination2");
var _a1=_a0.options;
var bb=_a0.bb={};
var _a2=$(_9f).addClass("pagination2").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");
var tr=_a2.find("tr");
...
var _a5=aa[_a4];
if(_a5=="list"){
var ps=$("<select class=\"pagination2-page-list\"></select>");
...
if(_a5=="sep"){
$("<td><div class=\"pagination2-btn-separator\"></div></td>").appendTo(tr);
}else{
if(_a5=="first"){
bb.first=_a6("first");
}else{
...
bb.num=$("<input class=\"pagination2-num\" type=\"text\" value=\"1\" size=\"2\">").appendTo(tr).wrap("<td></td>");
bb.num.unbind(".pagination2").bind("keydown.pagination2",function(e){
if(e.keyCode==13){
...
if(_a5=="links"){
$("<td class=\"pagination2-links\"></td>").appendTo(tr);
}
}
}
}
...
$("<div class=\"pagination2-info\"></div>").appendTo(_a2);
$("<div style=\"clear:both;\"></div>").appendTo(_a2);
function _a6(_a8){
var btn=_a1.nav[_a8];
var a=$("<a href=\"javascript:void(0)\"></a>").appendTo(tr);
a.wrap("<td></td>");
a.linkbutton({iconCls:btn.iconCls,plain:true}).unbind(".pagination2").bind("click.pagination2",function(){
...
var _ae=$.data(_ac,"pagination2").options;
_af(_ac,{pageNumber:_ad});
_ae.onSelectPage.call(_ac,_ae.pageNumber,_ae.pageSize);
};
function _af(_b0,_b1){
var _b2=$.data(_b0,"pagination2");
var _b3=_b2.options;
var bb=_b2.bb;
$.extend(_b3,_b1||{});
var ps=$(_b0).find("select.pagination2-page-list");
if(ps.length){
ps.val(_b3.pageSize+"");
...
var td=$(_b0).find("td.pagination2-links");
if(td.length){
td.empty();
...
var a=$("<a class=\"pagination2-link\" href=\"javascript:void(0)\"></a>").appendTo(td);
a.linkbutton({plain:true,text:i});
if(i==_b3.pageNumber){
a.linkbutton("select");
}else{
a.unbind(".pagination2").bind("click.pagination2",{pageNumber:i},function(e){
...
$(_b0).find("div.pagination2-info").html(_b7);
if(bb.first){
...
var _bb=$.data(_b9,"pagination2");
var _bc=_bb.options;
_bc.loading=_ba;
if(_bc.showRefresh&&_bb.bb.refresh){
_bb.bb.refresh.linkbutton({iconCls:(_bc.loading?"pagination2-loading":"pagination2-load")});
}
};
$.fn.pagination2=function(_bd,_be){//防止与pagination2分页插件冲突，重命名
if(typeof _bd=="string"){
return $.fn.pagination2.methods[_bd](this,_be);
}
_bd=_bd||{};
return this.each(function(){
var _bf;
var _c0=$.data(this,"pagination2");
if(_c0){
_bf=$.extend(_c0.options,_bd);
}else{
_bf=$.extend({},$.fn.pagination2.defaults,$.fn.pagination2.parseOptions(this),_bd);
$.data(this,"pagination2",{options:_bf});
}
_9e(this);
_af(this);
});
};
$.fn.pagination2.methods={options:function(jq){
return $.data(jq[0],"pagination2").options;
},loading:function(jq){
return jq.each(function(){
_b8(this,true);
});
...
$.fn.pagination2.parseOptions=function(_c3){
var t=$(_c3);
...
$.fn.pagination2.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_c4,_c5){
},onBeforeRefresh:function(_c6,_c7){
},onRefresh:function(_c8,_c9){
},onChangePageSize:function(_ca){
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"pagination2-first",handler:function(){
var _cb=$(this).pagination2("options");
if(_cb.pageNumber>1){
$(this).pagination2("select",1);
}
}},prev:{iconCls:"pagination2-prev",handler:function(){
var _cc=$(this).pagination2("options");
if(_cc.pageNumber>1){
$(this).pagination2("select",_cc.pageNumber-1);
}
}},next:{iconCls:"pagination2-next",handler:function(){
var _cd=$(this).pagination2("options");
var _ce=Math.ceil(_cd.total/_cd.pageSize);
if(_cd.pageNumber<_ce){
$(this).pagination2("select",_cd.pageNumber+1);
}
}},last:{iconCls:"pagination2-last",handler:function(){
var _cf=$(this).pagination2("options");
var _d0=Math.ceil(_cf.total/_cf.pageSize);
if(_cf.pageNumber<_d0){
$(this).pagination2("select",_d0);
}
}},refresh:{iconCls:"pagination2-refresh",handler:function(){
var _d1=$(this).pagination2("options");
if(_d1.onBeforeRefresh.call(this,_d1.pageNumber,_d1.pageSize)!=false){
$(this).pagination2("select",_d1.pageNumber);
...
_5ac.pagination2({total:(opts.pageNumber*opts.pageSize),pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_5ad,_5ae){
opts.pageNumber=_5ad;
opts.pageSize=_5ae;
_5ac.pagination2("refresh",{pageNumber:_5ad,pageSize:_5ae});
_5d7(_5a5);
}});
opts.pageSize=_5ac.pagination2("options").pageSize;
}
...
if(_614.length){
var _615=_614.pagination2("options");
if(_615.total!=data.total){
_614.pagination2("refresh",{total:data.total});
...
$(_68c).datagrid("getPager").pagination2("refresh",{total:data.total});
};
...
_694.push(_693.row);
$(_692).datagrid("getPager").pagination2("refresh",{total:data.total});
};
...
_697.push(row);
$(_696).datagrid("getPager").pagination2("refresh",{total:data.total});
};
function _698(_699){
...
_6e7.pagination2("refresh",{pageNumber:1});
_5d7(this,_6e6);
});
...
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
$(this).datagrid("getPager").pagination2("loading");
if(opts.loadMsg){
...
return jq.each(function(){
$(this).datagrid("getPager").pagination2("loaded");
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"正在请求，请稍后 ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination2:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_74c,_74d){
...
_7cd.pagination2({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_7ce,_7cf){
opts.pageNumber=_7ce;
opts.pageSize=_7cf;
_7d0(_7b8);
}});
opts.pageSize=_7cd.pagination2("options").pageSize;
}
};
...
if(!_7e8&&opts.pagination2){
var _7ed=$.data(_7e7,"treegrid").total;
var _7ee=$(_7e7).datagrid("getPager");
if(_7ee.pagination2("options").total!=_7ed){
_7ee.pagination2({total:_7ed});
}
}
_7d1(_7e7);
_7d9(_7e7);
...
_7d9(_830);
_832.total-=1;
$(_830).datagrid("getPager").pagination2("refresh",{total:_832.total});
...
$(this).treegrid("getPager").pagination2({pageNumber:1});
...
_972(this,q);
}},currentText:"今天",closeText:"清空",okText:"选择",buttons:[{text:function(_985){
...
$(_9a7).combo("setValue","").combo("setText","");
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
var h=date.getHours();
