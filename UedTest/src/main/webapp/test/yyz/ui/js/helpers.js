	...
	if(strIn.length>num){
		if(!window.showTLInfo){
			window.showTLInfo=function(info){
				art.dialog({
					  title: "详细信息",
					  content: '<p style="font-size:14px;min-width:200px;max-width:500px;word-wrap:break-word;word-break: break-all;color:#808080;">'+info+'</p>',
					  drag:false,
					  cancel: false,
					  lock:true,
					  opacity:0,
		...
		str+='<a href="javascript:void(0)" title="'+strIn+'" onclick="showTLInfo(\''+strIn+'\');return false;">...</a>';
	}
