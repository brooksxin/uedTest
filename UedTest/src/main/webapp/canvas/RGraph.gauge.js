    ...
    RGraph.Gauge = function (conf)
    {
        ...
        */
        ...
        this.DrawLabels = function ()
        {
            ...
            co.beginPath();
                for (var i=0; i<=num; ++i) {
                    var hyp = (this.radius - 25 - prop['chart.border.width']) - prop['chart.labels.offset'] - 5;//modeby zw 由于彩条变宽，重设描述文字圆的半径
        ...
        */
        ...
        this.DrawBottomTitle = function ()
        {
            ...
            }else{// modby zw 调整底部title的位置
                var _x = parseFloat(prop['chart.title.bottom.pos'].split(" ")[0],2);
                var _y = parseFloat(prop['chart.title.bottom.pos'].split(" ")[1],2);
                if(RG.ISOLD){
                    y = this.centery + (this.radius * _y * 0.85);
                }else{
                    y = this.centery + (this.radius * _y);
                }
                x = this.centerx + (this.radius * _x);
            }
            ...
            if (RG.is_array(prop['chart.colors.ranges'])) {
                ...
                for (var i=0; i<ranges.length; ++i) {
                    ...
                    co.beginPath();
                        co.arc(this.centerx,
                                         this.centery,
                                         this.radius - 10 - prop['chart.border.width'] + 10,//modby zw 设置刻度高度
                        ...
                        co.arc(this.centerx,
                                         this.centery,
                                         this.radius - 20 - prop['chart.border.width'] - 5,//modby zw 设置刻度高度
